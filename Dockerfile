...
HEALTHCHECK --interval=60s --timeout=5s --start-period=30s --start-interval=5s --retries=3 CMD curl --silent --output /dev/null --fail http://localhost:${PROOVR_ICS_PORT:-5000} || exit 1
